...
from calculator.operations import Addition as Add, Subtraction as Sub, Multiplication as Mult, Division as Divi
...
class Calculation:
    ...
    def __init__(self, cal_tuple_list: tuple):
        """ constructor method"""
        self.values = Calculation.convert_args_to_tuple_of_float(cal_tuple_list)

    @classmethod
    def create(cls, cal_tuple_list: tuple):
        """ factory method"""
        return cls(cal_tuple_list)

    @staticmethod
    def convert_args_to_tuple_of_float(cal_tuple_list):
...
class Division(Calculation):
    ...
    def get_result(self):
        ...
        result = Divi.divide(self.values)
        return result
